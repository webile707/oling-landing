                            ...
                            <div className="col-lg-4 offset-lg-0 col-md-8 offset-md-2 col-10 offset-1">
                                <div className="app-feature-single app-feature-single-1">
                                    <div className="app-feature-single-wrapper">
                                        ...
                                        <p className="c-grey">
                                            <a href="mailto:media@OLING.com" className="link-underline link-underline-1">
                                                <span>media@OLING.com</span>
                                            </a>
                                        </p>
                                        <p className="c-grey">
                                            <a href="mailto:support@OLING.com" className="link-underline link-underline-1">
                                                <span>support@OLING.com</span>
                                            </a>
                                        </p>
                                    </div>
                                </div>
