    ...
    const features = [
        {
            ...
            title: 'Easy to Use',
            content: "Under were male man blessed make given upon day  whose together very under darkness us under god you're our bring a isn't firmament meat has creature created won't cattle darkness whose so forth heaven you void it seasons grass grass."
        },
        {
            icon: 'las la-headset',
                        ...
                        <div className="row features-row">
                            {
                                features.map((feature, key) => {
                                    return (
                                        <div key={key} className="col-lg-6 offset-lg-0 col-md-6 offset-md-0 col-10 offset-1">
